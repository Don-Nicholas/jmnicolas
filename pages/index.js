...
export default function Home() {
  return (
    <div className="max-w-4xl mx-auto">
      {/* Navigation */}
      <nav className="grid grid-cols-2 md:grid-cols-3 md:m-10 m-5 ">
        <div className="">
        ...
        <div className="">
          ...
          <img src="/icons/twitter.png" alt="" className="md:w-7 w-4 inline-block mx-1" />
          <img src="/icons/linkedin.png" alt="" className="md:w-7 w-4 inline-block mx-2" />
          <img src="/icons/github.png" alt="" className="md:w-7 w-4 inline-block mx-1" />
          <img src="/icons/crescent-moon.png" alt="" className="md:w-7 w-4 inline-block mx-1" />
        </div>
        <div className="my-5">
          <a href="/about" className="mr-1 font-semibold md:text-xl">About</a>
          <a href="/projects" className="mx-1 font-semibold md:text-xl">Projects</a>
          <a href="/experience" className="mx-1 font-semibold md:text-xl">Experience</a>
          <a href="/contact" className="mx-1 font-semibold md:text-xl">Contact</a>
        </div>
      </nav>
      {/* landing page */}
      <div className="max-w-4xl mx-auto ">
